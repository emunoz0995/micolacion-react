...
export const getSectionsThunk = () => dispatch => {
    ...
    axios.get(`http://system.micolacion.com:3000/sections`)
...
export const getSectionsBySchoolThunk = (school_id) => dispatch => {
    dispatch(requestFetchSections())
    axios.get(`http://system.micolacion.com:3000/sections/${school_id}`)
        .then(res => {dispatch(fetchSectionsSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getSectionThunk = (section_id) => dispatch => {
    ...
    axios.get(`http://system.micolacion.com:3000/sections/section/${section_id}`)
...
export const createSectionThunk = (data) => dispatch => {
    ...
    axios.post(`http://system.micolacion.com:3000/sections/section`, data)
...
export const updateSectionThunk = (section_id, data) => dispatch => {
    ...
    axios.put(`http://system.micolacion.com:3000/sections/section/${section_id}`, data)
...
export const deleteSectionThunk = (section_id) => dispatch => {
    ...
    axios.delete(`http://system.micolacion.com:3000/sections/section/${section_id}`)
