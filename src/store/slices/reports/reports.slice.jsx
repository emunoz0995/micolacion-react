...
export const getGeneralReportThunk = (school_id) => dispatch => {
    ...
    axios.get(`http://system.micolacion.com:3000/reports/generalReport/${school_id}`)
...
export const getMenor5ReportThunk = (school_id) => dispatch => {
    dispatch(requestFetchReports())
    axios.get(`http://system.micolacion.com:3000/reports/menorFiveReport/${school_id}`)
        .then(res => {dispatch(fetchReportsSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getBreakFastReportThunk = (school_id) => dispatch => {
    dispatch(requestFetchReports())
    axios.get(`http://system.micolacion.com:3000/reports/reportBreakFast/${school_id}`)
        .then(res => {dispatch(fetchReportsSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getLunchReportThunk = (school_id) => dispatch => {
    dispatch(requestFetchReports())
    axios.get(`http://system.micolacion.com:3000/reports/reportLunches/${school_id}`)
        .then(res => {dispatch(fetchReportsSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
