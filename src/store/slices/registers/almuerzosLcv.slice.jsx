...
export const getAlmuerzosBMThunk = (school_id) => dispatch => {
    ...
    axios.get(`http://localhost:4000/almuerzos_lcv/lunch_bm/${school_id}`)
...
export const getAlmuerzosBEThunk = (school_id) => dispatch => {
    dispatch(requestFetchAlmuerzos())
    axios.get(`http://localhost:4000/almuerzos_lcv/lunch_be/${school_id}`)
        .then(res => {dispatch(fetchAlmuerzosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getAlmuerzosBSThunk = (school_id) => dispatch => {
    dispatch(requestFetchAlmuerzos())
    axios.get(`http://localhost:4000/almuerzos_lcv/lunch_bs/${school_id}`)
        .then(res => {dispatch(fetchAlmuerzosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getAlmuerzosEventualesThunk = (school_id) => dispatch => {
    dispatch(requestFetchAlmuerzos())
    axios.get(`http://localhost:4000/almuerzos_lcv/lunch_eventuales/${school_id}`)
        .then(res => {dispatch(fetchAlmuerzosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getAlmuerzosPersonalThunk = (school_id) => dispatch => {
    dispatch(requestFetchAlmuerzos())
    axios.get(`http://localhost:4000/almuerzos_lcv/lunch_personal/${school_id}`)
        .then(res => {dispatch(fetchAlmuerzosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getAlmuerzosProcesadosThunk = (school_id) => dispatch => {
    dispatch(requestFetchAlmuerzos())
    axios.get(`http://localhost:4000/almuerzos_lcv/lunch_procesados/${school_id}`)
        .then(res => {dispatch(fetchAlmuerzosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
