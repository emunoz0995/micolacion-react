...
export const getRefrigeriosBMThunk = (school_id) => dispatch => {
    ...
    axios.get(`http://localhost:3000/refrigerios_lcv/breakfast_bm/${school_id}`)
...
export const getRefrigeriosBEThunk = (school_id) => dispatch => {
    dispatch(requestFetchRefrigerios())
    axios.get(`http://localhost:3000/refrigerios_lcv/breakfast_be/${school_id}`)
        .then(res => {dispatch(fetchRefrigeriosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getRefrigeriosBSThunk = (school_id) => dispatch => {
    dispatch(requestFetchRefrigerios())
    axios.get(`http://localhost:3000/refrigerios_lcv/breakfast_bs/${school_id}`)
        .then(res => {dispatch(fetchRefrigeriosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getRefrigeriosEventualesThunk = (school_id) => dispatch => {
    dispatch(requestFetchRefrigerios())
    axios.get(`http://localhost:3000/refrigerios_lcv/breakfast_eventuales/${school_id}`)
        .then(res => {dispatch(fetchRefrigeriosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getRefrigeriosPersonalThunk = (school_id) => dispatch => {
    dispatch(requestFetchRefrigerios())
    axios.get(`http://localhost:3000/refrigerios_lcv/breakfast_personal/${school_id}`)
        .then(res => {dispatch(fetchRefrigeriosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
...
export const getRefrigeriosProcesadosThunk = (school_id) => dispatch => {
    dispatch(requestFetchRefrigerios())
    axios.get(`http://localhost:3000/refrigerios_lcv/breakfast_procesados/${school_id}`)
        .then(res => {dispatch(fetchRefrigeriosSuccess(res.data))
        })
        .catch(error => {
            if (error.response?.status === 400) {
