        ...
        <SchoolLayout value={searchTerm} options={aditionalServicesState.services} onchange={handleSearch} view={true}
            ...
            {isLoading ? (
                ...
                <div className="mx-5 my-5 w-full">
                    <TabParts
                        titleOne={'Servicios Adicionales'} toOne={`/schools/${school_id}/aditional_services_lcv`} activeOne={false}
                        titleSeven={'Procesados'} countProcces={countProcess} toSeven={`/schools/${school_id}/aditional_servicesProcess_lcv`} activeSeven={true}
                    />
...
export default AdicionalServicesProcesados;