...
const RefrigerioEventualesCervantes = () => {
        ...
        <SchoolLayout value={searchTerm} onchange={handleSearch} view={true}>
            {isLoading ? (
                ...
                <div className="mx-5 my-5 w-full">
                    <TabParts
                        titleOne={'Basica Elmental'} toOne={`/schools/${school_id}/refrigerios_primaria`} activeOne={false}
                        ...
                        titleFour={'Eventuales'} toFour={`/schools/${school_id}/refrigerios_eventuales_cervantes`} activeFour={true}
...
export default RefrigerioEventualesCervantes;