...
const RefrigerioProcesadosCervantes = () => {
    ...
    const getRefrigeriosProcesados = () => {
        ...
        axios.get(`https://system.micolacion.com/api/refrigerios_cervantes/breakfast_procesados/${school_id}`)
            .then(response => {
            ...
            {isLoading ? (
                ...
                <div className="mx-5 my-5 w-full">
                    <TabParts
                      ...
                      titleSix={'Procesados'} toSix={`/schools/${school_id}/refrigerios_procesados_cervantes`} activeSix={true}
                    />
