...
const AlmuerzoEventualesCervantes = () => {
            ...
            {isLoading ? (
                ...
                <div className="mx-5 my-5 w-full">
                    <TabParts
                        ...
                        titleFour={'Eventuales'} toFour={`/schools/${school_id}/almuerzos_eventuales_cervantes`} activeFour={true}
...
export default AlmuerzoEventualesCervantes;