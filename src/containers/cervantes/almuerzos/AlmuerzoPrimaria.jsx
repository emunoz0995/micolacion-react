...
const AlmuerzoPrimaria = () => {
    ...
    const getAlmuerzoPrimaria = () => {
        dispatch(setIsLoading(true));
        axios.get(`https://system.micolacion.com/api/almuerzos_cervantes/lunch_primaria/${school_id}`)
            .then(response => {
    ...
    return (
        <SchoolLayout value={searchTerm} onchange={handleSearch} view={true}>
            ...
            <div className="mx-5 my-5 w-full">
                <TabParts
                    titleOne={'Primaria'} toOne={`/schools/${school_id}/almuerzos_primaria`} activeOne={true}
...
export default AlmuerzoPrimaria;