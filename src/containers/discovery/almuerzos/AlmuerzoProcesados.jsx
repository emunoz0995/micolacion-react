...
const AlmuerzoProcesadosDiscovery = () => {
            ...
            {isLoading ? (
                ...
                <div className="mx-5 my-5 w-full">
                    <TabParts
                        ...
                        titleTree={'Eventuales'} toTree={`/schools/${school_id}/almuerzos_eventuales_discovery`} activeTree={false}
                        titleSeven={'Procesados'} countProcces={countProcess} toSeven={`/schools/${school_id}/almuerzos_procesados_discovery`} activeSeven={true}
                    />
...
export default AlmuerzoProcesadosDiscovery;