...
const RefrigerioEventualesDiscovery = () => {
        ...
        <SchoolLayout value={searchTerm} onchange={handleSearch} view={true}>
            {isLoading ? (
                ...
                <div className="mx-5 my-5 w-full">
                    <TabParts
                        titleOne={'Exploradores'} toOne={`/schools/${school_id}/refrigerios_exploradores`} activeOne={false}
                        titleTwo={'Descubridores'} toTwo={`/schools/${school_id}/refrigerios_descubridores`} activeTwo={false}
                        titleTree={'Eventuales'} toTree={`/schools/${school_id}/refrigerios_eventuales_discovery`} activeTree={true}
                        titleSeven={'Procesados'} countProcces={countProcces} toSeven={`/schools/${school_id}/refrigerios_procesados_discovery`} activeSeven={false}
                    />
...
export default RefrigerioEventualesDiscovery;