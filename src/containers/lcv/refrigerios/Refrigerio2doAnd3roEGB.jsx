...
const Refrigerio2doAnd3roEGB = () => {
    ...
    const getRefrigeriosPrimaria = () => {
        ...
        axios.get(`/api/refrigerios_lcv/breakfast_2do_3ro/${school_id}`)
            .then(response => {
        ...
        <SchoolLayout value={searchTerm} onchange={handleSearch} view={true}>
            ...
            <div className="mx-5 my-5 w-full">
                <TabParts
                   ...
                   titleTree={'Segundo Y Tercero EGB'} toTree={`/schools/${school_id}/refrigerios_2do_3ro_EGB`} activeTree={true}
...
export default Refrigerio2doAnd3roEGB;