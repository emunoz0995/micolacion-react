...
//SLICES
import { getAlmuerzosBMThunk } from '../../../store/slices/registers/almuerzosLcv.slice';
...
const AlmuerzoBM = () => {
    ...
    useEffect(() => {
        dispatch(getAlmuerzosBMThunk(school_id));
    }, []);
    ...
    return (
        <SchoolLayout>
            ...
            <div className="mx-5 my-5 w-full">
                <TabParts
                    titleOne={'Basica Media'} toOne={`/schools/${school_id}/almuerzos_bm`} activeOne={true}
