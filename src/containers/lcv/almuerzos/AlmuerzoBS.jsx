...
//SLICES
import { getAlmuerzosBSThunk } from '../../../store/slices/registers/almuerzosLcv.slice';
...
const AlmuerzoBS = () => {
    ...
    useEffect(() => {
        dispatch(getAlmuerzosBSThunk(school_id));
    }, []);
            ...
            {almuerzosState.fetching || almuerzosState.processing ? (
                ...
                <div className="mx-5 my-5 w-full">
                    <TabParts
                        ...
                        titleTree={'Basica BS-BGU '} toTree={`/schools/${school_id}/almuerzos_bs_bgu`} activeTree={true}
