...
//SLICES
import { getAlmuerzosBEThunk } from '../../../store/slices/registers/almuerzosLcv.slice';
...
const AlmuerzoBE = () => {
    ...
    useEffect(() => {
        dispatch(getAlmuerzosBEThunk(school_id));
    }, []);
        ...
        <SchoolLayout>
            ...
            <div className="mx-5 my-5 w-full">
                <TabParts
                    ...
                    titleTwo={'Basica Elemental'} toTwo={`/schools/${school_id}/almuerzos_be`} activeTwo={true}
