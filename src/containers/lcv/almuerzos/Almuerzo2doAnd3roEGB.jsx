...
const Almuerzo2doAnd3roEGB = () => {
    ...
    const getAlmuerzos2doy3ro = () => {
        dispatch(setIsLoading(true));
        axios.get(`/api/almuerzos_lcv/lunch_2do_3ro/${school_id}`)
            .then(response => {
        ...
        <SchoolLayout value={searchTerm} onchange={handleSearch} view={true}>
            ...
            <div className="mx-5 my-5 w-full">
                <TabParts
                   ...
                   titleTree={'Segundo Y Tercero EGB'} toTree={`/schools/${school_id}/almuerzos_2do_3ro_EGB`} activeTree={true}
...
export default Almuerzo2doAnd3roEGB;